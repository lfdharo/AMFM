# Implementation available at https://github.com/ocelma/python-recsys/blob/master/recsys/evaluation/ranking.py

from numpy import mean
from scipy.stats import kendalltau, spearmanr, rankdata
from operator import itemgetter

from recsys_evaluation import ROUND_FLOAT
from recsys_evaluation.baseclass import Evaluation
...
class AveragePrecision(Evaluation):
    ...
    def compute(self):
        super(AveragePrecision, self).compute()
        from recsys_evaluation.decision import PrecisionRecallF1
